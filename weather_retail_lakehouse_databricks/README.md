...
The 'weather_retail_lakehouse_databricks' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/weather_retail_lakehouse_databricks/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] weather_retail_lakehouse_databricks_etl` to your workspace.
